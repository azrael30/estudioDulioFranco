		...
		echo"
			<form action='modificandoCliente.php' method='post' id='modificarCliente'>
				<div class='row'>
					...
					<div class='col-sm-3'>
						<div class='form-group'>
							<input disabled class='form-control' type='text'  maxlength='6' value='".$cliente['idCliente']."'>
				...
				<div class='row'>
					...
					<div class='col-sm-3'>
						<div class='form-group'>
							<input class='form-control monto' type='text' name='honorarioBase' id='honorarioBase' maxlength='100' value='".$cliente['honorarioBase']."'>
						</div>
					</div>
				</div>
				<div class='row'>
